                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _TourMetric(label: route.slopeAngleLabel),
                    ],
                  ),
                ],
              ),
    ...
    return DraggableScrollableSheet(
      ...
      builder: (context, controller) => ListView(
        ...
        children: [
          ...
          const Text(
            'Slope angle is one part of avalanche assessment. Always combine it with the current bulletin, snowpack, aspect, terrain traps, and field observations.',
          ),
          const SizedBox(height: 18),
